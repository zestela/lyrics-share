  ...
  watch: {
    song_coverUrl() {
      ...
      imgElement.onload = async function () {
        ...
        document.getElementsByClassName("share-body")[0].style.setProperty("background-color", colorLst[0].hex)
      }
    }
  },
  methods: {
    async search_song() {
      ...
      document.getElementById("search_suggestions").style.setProperty("display", "block");
    },
    async setInfo(index) {
      ...
      document.getElementById("search_suggestions").style.setProperty("display", "none");
    },
